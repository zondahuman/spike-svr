...
public class SimpleDistributedQueue {
    ...
    private static final String path = "/dqueue/simple_queue";
    private static final CountDownLatch down = new CountDownLatch(1);

    public static void main(String[] args) throws Exception {

        CuratorFramework client = new SimpleDistributedQueue().getStartedClient(-1);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            service.submit(new Callable<Void>() {
                public Void call() throws Exception {
                    new SimpleDistributedQueue().schedule(index);
                    return null;
                }
            });
        }
    ...
    private void schedule(final int index) throws Exception {
        ...
        org.apache.curator.framework.recipes.queue.SimpleDistributedQueue queue = new org.apache.curator.framework.recipes.queue.SimpleDistributedQueue(client, path);
        if (index == 4) {
