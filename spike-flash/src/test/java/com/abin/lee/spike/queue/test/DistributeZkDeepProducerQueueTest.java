 ...
 */
public class DistributeZkDeepProducerQueueTest {

    //    private static final String httpURL = "http://localhost:8099/dqueue/zkPutDeepQueue";
    private static final String httpURL = "http://localhost:8099/dqueue/zkPutDeepQueue";

    @Test
    public void testDistributeZkDeepProducerQueue() {
        try {
