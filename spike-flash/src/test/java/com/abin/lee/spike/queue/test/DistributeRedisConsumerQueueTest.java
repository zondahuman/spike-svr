 ...
 */
public class DistributeRedisConsumerQueueTest {

    //    private static final String httpURL = "http://localhost:8099/dqueue/redisGetQueue";
    private static final String httpURL = "http://localhost:8099/dqueue/redisGetQueue";
    ...
    public void testDistributeConsumerQueue() {
        try {
            ...
            nvps.add(new BasicNameValuePair("destinationQueueName", "sextra"));
