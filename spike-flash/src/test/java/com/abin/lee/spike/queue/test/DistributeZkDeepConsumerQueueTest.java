 ...
 */
public class DistributeZkDeepConsumerQueueTest {

    //    private static final String httpURL = "http://localhost:8099/dqueue/zkGetDeepQueue";
    private static final String httpURL = "http://localhost:8099/dqueue/zkGetDeepQueue";

    @Test
    public void testDistributeZkDeepConsumerQueue() {
        try {
