 ...
 */
public class FlashByScriptTest {

    //    private static final String httpURL = "http://localhost:8099/spike/flashByScript";
    private static final String httpURL = "http://localhost:8080/spike/flashByScript";

    @Test
    public void testFlashByScript() {
        try {
