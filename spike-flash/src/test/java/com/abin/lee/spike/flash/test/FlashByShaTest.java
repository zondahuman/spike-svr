 ...
 */
public class FlashByShaTest {

    //    private static final String httpURL = "http://localhost:8099/spike/flashBySha";
    private static final String httpURL = "http://localhost:8080/spike/flashBySha";

    @Test
    public void testFlashBySha() {
        try {
