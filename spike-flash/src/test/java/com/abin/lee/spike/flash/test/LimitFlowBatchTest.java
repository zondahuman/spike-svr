 ...
 */
public class LimitFlowBatchTest {

    //    private static final String httpURL = "http://localhost:8099/spike/limitFlowBatch";
    private static final String httpURL = "http://localhost:8080/spike/limitFlowBatch";

    @Test
    public void testLimitFlowBatch() {
        try {
